...
Без аргументов команда открывает компактное интерактивное меню:

- репозитории GitHub — просмотр, клонирование и обновление локальной копии;
- локальные репозитории — поиск и запуск ранее клонированных `.sh`-скриптов;
